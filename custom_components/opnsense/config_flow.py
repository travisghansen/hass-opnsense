    ...
    return vol.Schema(
        {
            vol.Optional(
                ...
                default=user_input.get(
                    CONF_SYNC_TELEMETRY,
                    fallback.get(CONF_SYNC_TELEMETRY, DEFAULT_SYNC_OPTION_VALUE),
                ),
            ): selector.BooleanSelector(selector.BooleanSelectorConfig()),
            vol.Optional(
                CONF_SYNC_GATEWAYS,
                default=user_input.get(
                    CONF_SYNC_GATEWAYS, fallback.get(CONF_SYNC_GATEWAYS, DEFAULT_SYNC_OPTION_VALUE)
                ),
            ): selector.BooleanSelector(selector.BooleanSelectorConfig()),
            vol.Optional(
                CONF_SYNC_INTERFACES,
                default=user_input.get(
                    CONF_SYNC_INTERFACES,
                    fallback.get(CONF_SYNC_INTERFACES, DEFAULT_SYNC_OPTION_VALUE),
                ),
            ): selector.BooleanSelector(selector.BooleanSelectorConfig()),
            vol.Optional(
                CONF_SYNC_DHCP_LEASES,
                default=user_input.get(
                    CONF_SYNC_DHCP_LEASES,
                    fallback.get(CONF_SYNC_DHCP_LEASES, DEFAULT_SYNC_OPTION_VALUE),
                ),
            ): selector.BooleanSelector(selector.BooleanSelectorConfig()),
            vol.Optional(
                CONF_SYNC_NOTICES,
                default=user_input.get(
                    CONF_SYNC_NOTICES, fallback.get(CONF_SYNC_NOTICES, DEFAULT_SYNC_OPTION_VALUE)
                ),
            ): selector.BooleanSelector(selector.BooleanSelectorConfig()),
            vol.Optional(
                CONF_SYNC_FIRMWARE_UPDATES,
                default=user_input.get(
                    CONF_SYNC_FIRMWARE_UPDATES,
                    fallback.get(CONF_SYNC_FIRMWARE_UPDATES, DEFAULT_SYNC_OPTION_VALUE),
                ),
            ): selector.BooleanSelector(selector.BooleanSelectorConfig()),
            vol.Optional(
                CONF_SYNC_CARP,
                default=user_input.get(
                    CONF_SYNC_CARP, fallback.get(CONF_SYNC_CARP, DEFAULT_SYNC_OPTION_VALUE)
                ),
            ): selector.BooleanSelector(selector.BooleanSelectorConfig()),
            vol.Optional(
                CONF_SYNC_FILTERS_AND_NAT,
                default=user_input.get(
                    CONF_SYNC_FILTERS_AND_NAT,
                    fallback.get(CONF_SYNC_FILTERS_AND_NAT, DEFAULT_SYNC_OPTION_VALUE),
                ),
            ): selector.BooleanSelector(selector.BooleanSelectorConfig()),
            vol.Optional(
                CONF_SYNC_SERVICES,
                default=user_input.get(
                    CONF_SYNC_SERVICES, fallback.get(CONF_SYNC_SERVICES, DEFAULT_SYNC_OPTION_VALUE)
                ),
            ): selector.BooleanSelector(selector.BooleanSelectorConfig()),
            vol.Optional(
                CONF_SYNC_VPN,
                default=user_input.get(
                    CONF_SYNC_VPN, fallback.get(CONF_SYNC_VPN, DEFAULT_SYNC_OPTION_VALUE)
                ),
            ): selector.BooleanSelector(selector.BooleanSelectorConfig()),
            vol.Optional(
                CONF_SYNC_CERTIFICATES,
                default=user_input.get(
                    CONF_SYNC_CERTIFICATES,
                    fallback.get(CONF_SYNC_CERTIFICATES, DEFAULT_SYNC_OPTION_VALUE),
                ),
            ): selector.BooleanSelector(selector.BooleanSelectorConfig()),
            vol.Optional(
                CONF_SYNC_UNBOUND,
                default=user_input.get(
                    CONF_SYNC_UNBOUND, fallback.get(CONF_SYNC_UNBOUND, DEFAULT_SYNC_OPTION_VALUE)
                ),
            ): selector.BooleanSelector(selector.BooleanSelectorConfig()),
        }
    )
