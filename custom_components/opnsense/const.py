...
VERSION = "v1.0.8"  # x-release-please-version
DOMAIN = "opnsense"
...
CONF_DEVICE_TRACKER_RESOLVE_HOSTNAMES = "device_tracker_resolve_hostnames"
DEFAULT_DEVICE_TRACKER_RESOLVE_HOSTNAMES = False
