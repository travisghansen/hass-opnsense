...
## What's Changed
### 📚 Documentation
* Add pydoclint documentation checks by [@Snuffy2](https://github.com/Snuffy2) in [#694](https://github.com/travisghansen/hass-opnsense/pull/694)
### 🎓 Code Quality
* test: streamline redundant test coverage by [@Snuffy2](https://github.com/Snuffy2) in [#696](https://github.com/travisghansen/hass-opnsense/pull/696)
### 🧰 Maintenance
* Bump aiopnsense to 1.1.7 by [@github-actions](https://github.com/github-actions)[bot] in [#695](https://github.com/travisghansen/hass-opnsense/pull/695)


**Full Changelog**: https://github.com/travisghansen/hass-opnsense/compare/v1.0.4...v1.0.5
...
**Full Changelog**: https://github.com/travisghansen/hass-opnsense/compare/v1.0.3...v1.0.4<p><i>For firmware versions below the minimum version, the integration will not permit new installations and existing installations will no longer start. Firmware versions below the recommended version will likely work but may have limited features and/or show errors in the logs.</i>
...
## What's Changed
### ✨ New Features
* Add privacy-safe OPNsense diagnostics by [@Snuffy2](https://github.com/Snuffy2) in [#668](https://github.com/travisghansen/hass-opnsense/pull/668)
### 🐛 Bug Fixes
* docs: fix default Device Tracker Scan Interval in README table by [@amir-rezaei](https://github.com/amir-rezaei) in [#670](https://github.com/travisghansen/hass-opnsense/pull/670)
* Allow migration without firewall privileges by [@Snuffy2](https://github.com/Snuffy2) in [#667](https://github.com/travisghansen/hass-opnsense/pull/667)
...
**Full Changelog**: https://github.com/travisghansen/hass-opnsense/compare/v1.0.1...v1.0.2<p><i>For firmware versions below the minimum version, the integration will not permit new installations and existing installations will no longer start. Firmware versions below the recommended version will likely work but may have limited features and/or show errors in the logs.</i>
...
## What's Changed
### ✨ New Features
* Add CARP maintenance mode switch by [@Snuffy2](https://github.com/Snuffy2) in [#607](https://github.com/travisghansen/hass-opnsense/pull/607)
* Add SMART disk sensors by [@Snuffy2](https://github.com/Snuffy2) in [#605](https://github.com/travisghansen/hass-opnsense/pull/605)
### 🐛 Bug Fixes
* Fix SMART device lookups and error handling by [@Snuffy2](https://github.com/Snuffy2) in [#610](https://github.com/travisghansen/hass-opnsense/pull/610)
### 🎓 Code Quality
* Add cleanup for prek autoupdate PRs by [@Snuffy2](https://github.com/Snuffy2) in [#599](https://github.com/travisghansen/hass-opnsense/pull/599)
* test: consolidate parameterized coverage by [@Snuffy2](https://github.com/Snuffy2) in [#601](https://github.com/travisghansen/hass-opnsense/pull/601)
* Align aiopnsense log level and add switch coverage by [@Snuffy2](https://github.com/Snuffy2) in [#609](https://github.com/travisghansen/hass-opnsense/pull/609)
### 🧰 Maintenance
* Bump aiopnsense to 1.0.10 by [@github-actions](https://github.com/github-actions)[bot] in [#600](https://github.com/travisghansen/hass-opnsense/pull/600)
* Bump aiopnsense to 1.0.11 by [@github-actions](https://github.com/github-actions)[bot] in [#606](https://github.com/travisghansen/hass-opnsense/pull/606)
...
**Full Changelog**: https://github.com/travisghansen/hass-opnsense/compare/v0.6.7...v0.7.0<p><i>For firmware versions below the minimum version, the integration will not permit new installations and existing installations will no longer start. Firmware versions below the recommended version will likely work but may have limited features and/or show errors in the logs.</i>
...
## What's Changed
### 🐛 Bug Fixes
* Fix Granular Sync Typo by [@Snuffy2](https://github.com/Snuffy2) in [#569](https://github.com/travisghansen/hass-opnsense/pull/569)
* Refactor plugin check by [@Snuffy2](https://github.com/Snuffy2) in [#574](https://github.com/travisghansen/hass-opnsense/pull/574)
### 🎓 Code Quality
* Change to prek.toml by [@Snuffy2](https://github.com/Snuffy2) in [#579](https://github.com/travisghansen/hass-opnsense/pull/579)
### 🧰 Maintenance
* Bump aiopnsense to 1.0.8 by [@github-actions](https://github.com/github-actions)[bot] in [#562](https://github.com/travisghansen/hass-opnsense/pull/562)
* Create lock_closed_issues.yml by [@Snuffy2](https://github.com/Snuffy2) in [#571](https://github.com/travisghansen/hass-opnsense/pull/571)
* Update lock_closed_issues.yml by [@Snuffy2](https://github.com/Snuffy2) in [#572](https://github.com/travisghansen/hass-opnsense/pull/572)
* Update lock_closed_issues.yml by [@Snuffy2](https://github.com/Snuffy2) in [#573](https://github.com/travisghansen/hass-opnsense/pull/573)
* Update update_aiopnsense_manifest.yml by [@Snuffy2](https://github.com/Snuffy2) in [#570](https://github.com/travisghansen/hass-opnsense/pull/570)
* Add prek autoupdate GitHub Action by [@Snuffy2](https://github.com/Snuffy2) in [#575](https://github.com/travisghansen/hass-opnsense/pull/575)
* Fix prek autoupdate by [@Snuffy2](https://github.com/Snuffy2) in [#576](https://github.com/travisghansen/hass-opnsense/pull/576)
### Other Changes
...
**Full Changelog**: https://github.com/travisghansen/hass-opnsense/compare/v0.6.4...v0.6.5<p><i>For firmware versions below the minimum version, the integration will not permit new installations and existing installations will no longer start. Firmware versions below the recommended version will likely work but may have limited features and/or show errors in the logs.</i>
...
## What's Changed
### 🚀 Enhancements
* Improve Device Tracker UI by [@Snuffy2](https://github.com/Snuffy2) in [#527](https://github.com/travisghansen/hass-opnsense/pull/527)
### 🐛 Bug Fixes
* Handle if DHCP endpoints are unavailable by [@Snuffy2](https://github.com/Snuffy2) in [#533](https://github.com/travisghansen/hass-opnsense/pull/533)
### Other Changes
...
**Full Changelog**: https://github.com/travisghansen/hass-opnsense/compare/v0.6.1...v0.6.2<p><i>For firmware versions below the minimum version, the integration will not permit new installations and existing installations will no longer start. Firmware versions below the recommended version will likely work but may have limited features and/or show errors in the logs.</i>
...
[v1.0.5]: https://github.com/travisghansen/hass-opnsense/compare/v1.0.4...v1.0.5
