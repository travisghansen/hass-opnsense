...
def _build_smart_status_binary_sensor(
    ...
    Args:
        make_config_entry (Callable[..., MockConfigEntry]): Config-entry factory fixture.
        state (Any): Coordinator data to bind to the sensor.
        key (str): Entity description key to test.
